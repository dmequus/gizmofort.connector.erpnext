...
{
    public class ERPPurchase_invoice_advance : ERPNextObjectBase
    {
        public ERPPurchase_invoice_advance() : this(new ERPObject(DocType.Purchase_invoice_advance)) { }
        public ERPPurchase_invoice_advance(ERPObject obj) : base(obj) { }

        public static ERPPurchase_invoice_advance Create(string referencetype, string referencename, string remarks, string referencerow, double advanceamount, double allocatedamount)

        {
            ERPPurchase_invoice_advance obj = new ERPPurchase_invoice_advance();
