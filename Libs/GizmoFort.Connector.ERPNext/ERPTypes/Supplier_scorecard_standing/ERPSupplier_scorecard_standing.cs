...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Supplier_scorecard_standing
{
    public class ERPSupplier_scorecard_standing : ERPNextObjectBase
    {
        ...
        public static ERPSupplier_scorecard_standing Create(string standingname, Standingcolor standingcolor, double mingrade, double maxgrade, long warnrfqs, long warnpos, long preventrfqs, long preventpos, long notifysupplier, long notifyemployee, string employeelink)
