...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Sales_order_item
{
    public class ERPSales_order_item : ERPNextObjectBase
    {
        ...
        private int _ensure_delivery_based_on_produced_serial_no = 0;
        public int ensure_delivery_based_on_produced_serial_no
        {
            get { return data._ensure_delivery_based_on_produced_serial_no; }
            set { data._ensure_delivery_based_on_produced_serial_no = value; }
        }
        ...
        private double _gross_profit = 0.0;
        public double gross_profit
        {
            get { return data._gross_profit; }
            set { data._gross_profit = value; }
        }
        ...
        private double _work_order_qty = 0.0;
        public double work_order_qty
        {
            get { return data._work_order_qty; }
            set { data._work_order_qty = value; }
        }
